                    ...
                    <div class="tab-pane fade" id="panel8" role="tabpanel">
                        ...
                        <div class="modal-body">
                            <form method="post">
                                ...
                                <div class="md-form form-sm mb-5">
                                    <i class="fa fa-user prefix"></i>
                                    <input type="text" id="username_full" name="username_full" class="form-control form-control-sm validate">
                                    <label data-error="wrong" data-success="right" for="username_full">Nombre completo</label>
                                </div>
                                <!-- @mail -->
                                <div class="md-form mb-5">
                                    <i class="fa fa-envelope prefix grey-text"></i>
                                    <input type="email" id="email" name="email" class="form-control validate">
                                    <label data-error="wrong" data-success="right" for="email">@mail</label>
                                </div>
                               <!-- Pasword -->                                
                                <div class="md-form form-sm mb-5">
                                    <i class="fa fa-lock prefix"></i>
